        ...
        <>
            ...
            >
                ...
                <Modal.Footer>
                    ...
                    <button onClick={handleClose} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" type="button">
                        Close
                    </button>
                    <button form='editmodal' className="bg-yellow-300 hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded" type="button">
                        Update
                    </button>
                </Modal.Footer>
            </Modal>
